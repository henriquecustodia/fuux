...
Thinking about that, I have created this library to independently which template we've to use! 
Thus we'll can to use Flexbox semanticly and easily, into any project. \o/ 
